    ...
    <section>
      ...
      <form className='mt-6' onSubmit={handleSubmit}>
        ...
        <div className='mt-4'>
          ...
          <input className='w-full px-4 py-2 mt-2 bg-white border rounded-md' 
                type="text" name="title" id="title" onChange={handleChange} value={product.title} />
        </div>

        <div className='mt-4'>
          <label htmlFor="description">설명</label>
          <input className='w-full px-4 py-2 mt-2 bg-white border rounded-md' 
                type="text" name="description" id="description" onChange={handleChange} value={product.description} />
        </div>  
